...
-- 1. 工作台
INSERT INTO `menus` (`id`, `parent_id`, `name`, `title`, `path`, `component`, `icon`, `type`, `sort`, `is_enable`, `keep_alive`, `is_iframe`, `is_hide`, `is_hide_tab`, `is_full_page`, `fixed_tab`, `show_badge`, `roles`, `created_at`, `updated_at`)
...
-- 4. 结果页
INSERT INTO `menus` (`id`, `parent_id`, `name`, `title`, `path`, `component`, `icon`, `type`, `sort`, `is_enable`, `keep_alive`, `is_iframe`, `is_hide`, `is_hide_tab`, `is_full_page`, `fixed_tab`, `show_badge`, `created_at`, `updated_at`)
...
INSERT INTO `menus` (`id`, `parent_id`, `name`, `title`, `path`, `component`, `icon`, `type`, `sort`, `is_enable`, `keep_alive`, `is_iframe`, `is_hide`, `is_hide_tab`, `is_full_page`, `fixed_tab`, `show_badge`, `active_path`, `auth_list`, `created_at`, `updated_at`)
VALUES
...
INSERT INTO `menus` (`id`, `parent_id`, `name`, `title`, `path`, `component`, `icon`, `type`, `sort`, `is_enable`, `keep_alive`, `is_iframe`, `is_hide`, `is_hide_tab`, `is_full_page`, `fixed_tab`, `show_badge`, `roles`, `auth_list`, `created_at`, `updated_at`)
VALUES
